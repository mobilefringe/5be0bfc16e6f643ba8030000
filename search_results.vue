	...
	<div>
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <inside-header-component pageName="Search Results"></inside-header-component>
            			...
            			<div v-for="(result,index) in searchResults" :key="index">
                            <div class="row result_container_row">
                                <div v-if="result.is_store" class="col-sm-3 store_details_image center-block">
                                    <div v-if="result.store_front_url_abs && _.includes(result.store_front_url_abs,'missing') || (!result.store.store_front_url_abs && _.includes(result.store.store_front_url_abs,'missing'))">
                                        <div class="no_logo">
