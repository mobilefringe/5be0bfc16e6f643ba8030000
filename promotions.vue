                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <p class="promo_store_name">
                                                    ...
                                                    <span>| </span>
                                                    <span v-if="isMultiDay(promo)" class="promo_date">{{ promo.start_date | moment("MM D", timezone)}} to {{ promo.end_date | moment("MMMM D", timezone)}}</span>
                                                    <span v-else class="promo_date">{{ promo.start_date | moment("MM D", timezone)}}</span>
                                                </p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <p class="promo_store_name">
                                                    ...
                                                    <span v-else>{{ property.name }}</span>
                                                    <span>| </span>
                                                    <span v-if="isMultiDay(event)" class="promo_date">{{ event.start_date | moment("MM D", timezone)}} to {{ event.end_date | moment("MMMM D", timezone)}}</span>
