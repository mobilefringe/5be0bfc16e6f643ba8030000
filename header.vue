            ...
            <div class="row logo_container">
                <div class="col-md-3">
                    <div class="site_logo center-block">
                        <a href="/">
                            <img :alt="siteInfo.siteName" src="//codecloud.cdn.speedyrails.net/sites/5d9e3b816e6f6459bd010000/image/png/1542734272332/New Coral Ridge Mall Logo_2012.png">
                        </a>
                    </div>
    					    ...
    					    <nav id="mobile_nav" v-show="showMenu" class="">
    					        <ul>
    					            <li v-for="(item,key) in menu_items" class="menu_item">
    							        <!--<router-link :to="item.href" v-if="item.sub_menu == undefined" @click="closeMobileMenu()">{{$t(item.name)}}</router-link>-->
    						    ...
    						    <div class="mobile_nav_content">
                                    ...
                                    <div class="mobile_property_address center">
                                        <p>{{ property.name }}<br>
                                            <a :href="siteInfo.googleMapsURL" target="_blank" v-html="getPropertyAddress"></a>
                                        </p>
                                    </div>
    							</div>
    						</nav>
    ...
    define(["Vue", "vuex", "vue!today_hours.vue", "bootstrap-vue", "json!site.json", 'vue!search-component'], function (Vue, Vuex, TodayHoursComponent, BootstrapVue, site, SearchComponent) {
        ...
        return Vue.component("header-component", {
            ...
            computed: {
                ...
                getPropertyAddress() {
                    return this.property.address1 + ' <br/> ' + this.property.city + ' <br/> ' +  this.property.province_state + ', ' + this.property.country 
                }
            },
            methods: {
